    ...
    export default ({
        data: function(){
            return {
                ...
                scrolling: false,
                isFirstFrame: false,
                //custom scroll html event
                scrollEvent: 'undefined',
            }
        },
        computed: {
            wrapperWidth: function(){
                return this.options.wrapperWidth || (this.$el ? this.$el.offsetWidth : 0)
            },
            transform: function(){
                return {
            ...
            transition: function(){
                if(this.easing && this.shouldEasing){
                    return {
        ...
        methods: {
            _startEasing: function(){
                if(this.shouldEasing)
                    this.easing = true
            },
            _stopEasing: function(){
                if(this.shouldEasing)
                    this.easing = false
            },
            initSwiper: function(){
